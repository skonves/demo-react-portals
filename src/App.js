      ...
      <div className="App">
        ...
        {this.state.showInline ? (
          <React.Fragment>
            ...
            <video ref={this.video} src="https://i.gifer.com/l44.mp4" loop />
          </React.Fragment>
        ) : (
          <PopupWindow onClose={this.handleClose}>
            <button onClick={this.handleClickInline}>inline</button>
            <video ref={this.video} src="https://i.gifer.com/l44.mp4" loop />
          </PopupWindow>
        )}
        <button onClick={() => this.video.current.pause()}>pause</button>
        <button onClick={() => this.video.current.play()}>play</button>
